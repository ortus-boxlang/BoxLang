...
//            else if (result.correct) {
			if (result.correct) {
				...
				val bOMInputStream = BOMInputStream(file.inputStream())
				val bom = bOMInputStream.bom
				val charsetName: String = if (bom == null) "none" else bom.getCharsetName()
				println("${file.absolutePath} $charsetName")
				// really?
