...
public class HelloWorld$cfm implements ITemplate {
	...
	public static final ??? ast = astRep;
	 ...
	 */
	pubilc static invoke( ExecutionContext context ) throws Throwable {
		...
		if( EqualsEquals.invoke( context, variablesScope.get( Key.of( "GREETING" ) ), "Hello" ) ) {
			...
			Invoker.invoke(
				...
				new Object[] {
					Concat.invoke(
						context,
						context.scopeFind( Key.of( "GREETING" ) ),
						" world"
					)
				},
