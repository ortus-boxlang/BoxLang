...
public class Key implements Comparable<Key>, Serializable {
	...
	public static final Key		_byte								= Key.of( "byte" );
	public static final Key		_char								= Key.of( "char" );
	...
	public static final Key		_final								= Key.of( "final" );
	public static final Key		_float								= Key.of( "float" );
	public static final Key		_hashCode							= Key.of( "hashCode" );
	public static final Key		_HASHCODE							= Key.of( "hashcode" );
	public static final Key		_IMPLEMENTS							= Key.of( "implements" );
	public static final Key		_int								= Key.of( "int" );
	...
	public static final Key		_void								= Key.of( "void" );
	...
	public static final Key		boxfile								= Key.of( "boxfile" );
	...
	public static final Key		bytesReceived						= Key.of( "bytesReceived" );
	public static final Key		bytesSent							= Key.of( "bytesSent" );
	...
	public static final Key		categories							= Key.of( "categories" );
	...
	public static final Key		chunkCount							= Key.of( "chunkCount" );
	...
	public static final Key		createdAt							= Key.of( "createdAt" );
	...
	public static final Key		customComponentPaths				= Key.of( "customComponentPaths" );
	public static final Key		customComponentsDirectory			= Key.of( "customComponentsDirectory" );
	...
	public static final Key		decimal								= Key.of( "decimal" );
	...
	public static final Key		dependencies						= Key.of( "dependencies" );
	...
	public static final Key		failedRequests						= Key.of( "failedRequests" );
	...
	public static final Key		filterDelimiters					= Key.of( "filterDelimiters" );
	...
	public static final Key		httpProtocolFailures				= Key.of( "httpProtocolFailures" );
	...
	public static final Key		isDaily								= Key.of( "isDaily" );
	...
	public static final Key		javaLangBoolean						= Key.of( "java.lang.Boolean" );
	public static final Key		javaLangByte						= Key.of( "java.lang.Byte" );
	public static final Key		javaLangCharacter					= Key.of( "java.lang.Character" );
	public static final Key		javaLangDouble						= Key.of( "java.lang.Double" );
	public static final Key		javaLangFloat						= Key.of( "java.lang.Float" );
	public static final Key		javaLangInteger						= Key.of( "java.lang.Integer" );
	public static final Key		javaLangLong						= Key.of( "java.lang.Long" );
	public static final Key		javaLangObject						= Key.of( "java.lang.Object" );
	public static final Key		javaLangShort						= Key.of( "java.lang.Short" );
	public static final Key		javaLangString						= Key.of( "java.lang.String" );
	public static final Key		javaLibraryPaths					= Key.of( "javaLibraryPaths" );
	public static final Key		javaMathBigDecimal					= Key.of( "java.math.BigDecimal" );
	public static final Key		javaMathBigInteger					= Key.of( "java.math.BigInteger" );
	public static final Key		javascriptvar						= Key.of( "javascriptvar" );
	public static final Key		javaSettings						= Key.of( "javaSettings" );
	public static final Key		javaTimeInstant						= Key.of( "java.time.Instant" );
	public static final Key		javaTimeLocalDate					= Key.of( "java.time.LocalDate" );
	public static final Key		javaTimeLocalDateTime				= Key.of( "java.time.LocalDateTime" );
	public static final Key		javaTimeLocalTime					= Key.of( "java.time.LocalTime" );
	...
	public static final Key		lastUsedTimestamp					= Key.of( "lastUsedTimestamp" );
	...
	public static final Key		localDate							= Key.of( "LocalDate" );
	public static final Key		localDateTime						= Key.of( "LocalDateTime" );
	...
	public static final Key		localTime							= Key.of( "LocalTime" );
	...
	public static final Key		maxExecutionTimeMs					= Key.of( "maxExecutionTimeMs" );
	...
	public static final Key		minExecutionTimeMs					= Key.of( "minExecutionTimeMs" );
	...
	public static final Key		numericAsc							= Key.of( "numericAsc" );
	public static final Key		numericDesc							= Key.of( "numericDesc" );
	...
	public static final Key		onException							= Key.of( "onException" );
	public static final Key		onLoad								= Key.of( "onLoad" );
	public static final Key		onMessage							= Key.of( "onMessage" );
	public static final Key		onMisfire							= Key.of( "onMisfire" );
	...
	public static final Key		publish								= Key.of( "publish" );
	...
	public static final Key		queryOptions						= Key.of( "queryOptions" );
	...
	public static final Key		repeat								= Key.of( "repeat" );
	...
	public static final Key		retryCount							= Key.of( "retryCount" );
	...
	public static final Key		rowIDs								= Key.of( "rowIDs" );
	...
	public static final Key		startDate							= Key.of( "startDate" );
	...
	public static final Key		successfulRequests					= Key.of( "successfulRequests" );
	...
	public static final Key		textAsc								= Key.of( "textAsc" );
	public static final Key		textDesc							= Key.of( "textDesc" );
	public static final Key		textNoCaseAsc						= Key.of( "textNoCaseAsc" );
	public static final Key		textNoCaseDesc						= Key.of( "textNoCaseDesc" );
	...
	public static final Key		throwable							= Key.of( "throwable" );
	...
	public static final Key		timeoutFailures						= Key.of( "timeoutFailures" );
	...
	public static final Key		tlsFailures							= Key.of( "tlsFailures" );
	...
	public static final Key		totalExecutionTimeMs				= Key.of( "totalExecutionTimeMs" );
	...
	public static final Key		Zip									= Key.of( "Zip" );
