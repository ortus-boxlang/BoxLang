...
public class BoxCallableStatement extends BoxPreparedStatement implements java.sql.CallableStatement {
	 ...
	 * @param delegate      The underlying JDBC CallableStatement.
	 */
	public BoxCallableStatement( BoxConnection boxConnection, CallableStatement delegate ) {
		super( boxConnection, delegate );
		this.delegate = delegate;
	}

	/**
	 * Get the underlying CallableStatement delegate.
	 */
	@Override
