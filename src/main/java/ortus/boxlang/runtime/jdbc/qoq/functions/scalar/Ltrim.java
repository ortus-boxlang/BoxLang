...
public class Ltrim extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "ltrim" );

	public static final QoQScalarFunctionDef	INSTANCE	= new Ltrim();
	...
	public Object apply( List<Object> args, List<SQLExpression> expressions ) {
		String	str		= StringCaster.cast( args.get( 0 ) );
		int		start	= 0;
