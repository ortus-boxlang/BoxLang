...
public class Coalesce extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "coalesce" );

	public static final QoQScalarFunctionDef	INSTANCE	= new Coalesce();
