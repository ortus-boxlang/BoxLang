...
public class Floor extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "floor" );

	public static final QoQScalarFunctionDef	INSTANCE	= new Floor();
	...
	public Object apply( List<Object> args, List<SQLExpression> expressions ) {
		return ortus.boxlang.runtime.bifs.global.math.Floor._invoke( NumberCaster.cast( args.get( 0 ) ) );
	}
