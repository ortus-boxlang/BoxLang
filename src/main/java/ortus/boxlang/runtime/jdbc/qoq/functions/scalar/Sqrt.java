...
public class Sqrt extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "sqrt" );

	public static final QoQScalarFunctionDef	INSTANCE	= new Sqrt();
	...
	public Object apply( List<Object> args, List<SQLExpression> expressions ) {
		return ortus.boxlang.runtime.bifs.global.math.Sqr._invoke( NumberCaster.cast( args.get( 0 ) ) );
	}
