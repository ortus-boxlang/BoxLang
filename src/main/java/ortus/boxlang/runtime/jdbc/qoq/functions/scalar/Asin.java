...
public class Asin extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "asin" );

	public static final QoQScalarFunctionDef	INSTANCE	= new Asin();
	...
	public Object apply( List<Object> args, List<SQLExpression> expressions ) {
		return ortus.boxlang.runtime.bifs.global.math.Asin._invoke( DoubleCaster.cast( args.get( 0 ) ) );
	}
