...
public class Cos extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "cos" );

	public static final QoQScalarFunctionDef	INSTANCE	= new Cos();
	...
	public Object apply( List<Object> args, List<SQLExpression> expressions ) {
		return ortus.boxlang.runtime.bifs.global.math.Cos._invoke( NumberCaster.cast( args.get( 0 ) ) );
	}
