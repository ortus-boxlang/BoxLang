...
public class IsNull extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "isnull" );

	public static final QoQScalarFunctionDef	INSTANCE	= new IsNull();
