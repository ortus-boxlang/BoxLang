...
public class Concat extends QoQScalarFunctionDef {

	private static final Key					name		= Key.of( "concat" );

	public static final QoQScalarFunctionDef	INSTANCE	= new Concat();
	...
	public Object apply( List<Object> args, List<SQLExpression> expressions ) {
		...
		for ( Object arg : args ) {
			sb.append( StringCaster.cast( arg ) );
		}
		return sb.toString();
	}
