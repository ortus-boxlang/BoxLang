...
/**
 * I handle casting anything to a Array that needs to be assignable
 * This means I reject
 * - ImmutableLists
 * - UnmodifiableLists
 * 
 * I will ALLOW native Java arrays, because while their length is fixed, their
 * indexes can be assigned.
 */
public class AssignableArrayCaster implements IBoxCaster {
	...
	public static Array cast( Object object, Boolean fail ) {
		...
		if ( object instanceof UnmodifiableArray ) {
			throw new BoxCastException( "Can't cast UnmodifiableArray to a assignable Array." );
		}
		...
		if ( object instanceof List && object.getClass().getName().contains( "Immutable" ) ) {
			throw new BoxCastException( "Can't cast Unmodifiable List to a assignable Array." );
		}
