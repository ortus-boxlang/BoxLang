...
public class SetMap extends BIF {
	...
	/**
	 * @argument.set The source set.
	 *
	 * @argument.callback Receives {@code (value, ordinal, set)} and returns the transformed value.
	 *
	 * @return A new {@link ortus.boxlang.runtime.types.BoxSet} of the same variant containing the
	 *         deduplicated transformed values.
	 */
