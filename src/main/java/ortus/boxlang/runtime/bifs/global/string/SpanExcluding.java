...
public class SpanExcluding extends BIF {
	 ...
	 *
	 * @return A string; characters from string, from the beginning to a character that is in set.
	 */
	public Object _invoke( IBoxContext context, ArgumentsScope arguments ) {
		...
		// Return the substring from the beginning to the character that is in the set.
