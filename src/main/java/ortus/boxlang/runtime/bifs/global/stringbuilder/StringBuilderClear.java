...
@BoxBIF( description = "Resets the StringBuilder buffer to empty without allocating a new object. Returns the StringBuilder for chaining." )
@BoxMember( type = BoxLangType.STRING_BUILDER_STRICT, name = "clear" )
public class StringBuilderClear extends BIF {
	 ...
	 *
	 * @argument.stringBuilder The StringBuilder to clear.
	 */
	@Override
