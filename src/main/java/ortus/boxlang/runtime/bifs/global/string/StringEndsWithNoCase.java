...
@BoxBIF( description = "Determines whether a string ends with a specified suffix, case-insensitive" )
@BoxMember( type = BoxLangType.STRING_STRICT )
public class StringEndsWithNoCase extends BIF {

	/**
	 * Constructor
	 */
	public StringEndsWithNoCase() {
		super();
	 ...
	 *
	 * @argument.substring The suffix to check for.
	 *
	 * @return True if the string ends with the specified suffix (case-insensitive), false otherwise.
	 */
