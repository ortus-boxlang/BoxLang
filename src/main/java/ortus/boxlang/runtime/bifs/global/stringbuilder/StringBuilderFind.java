...
public class StringBuilderFind extends BIF {
	...
	public Object _invoke( IBoxContext context, ArgumentsScope arguments ) {
		...
		boolean				noCase	= arguments.getAsKey( BIF.__functionName ).equals( Key.findNoCase );
		return sb.find( arguments.getAsString( Key.substring ), arguments.getAsInteger( Key.start ), noCase );
	}
