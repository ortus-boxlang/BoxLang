...
@BoxBIF
@BoxMember( type = BoxLangType.STRING_BUILDER_STRICT, name = "right" )
public class StringBuilderRight extends BIF {

	public StringBuilderRight() {
		super();
		declaredArguments = new Argument[] {
		    new Argument( true, Argument.STRING_BUILDER, Key.stringBuilder ),
		    new Argument( true, Argument.INTEGER, Key.count )
		};
	}
	...
	public Object _invoke( IBoxContext context, ArgumentsScope arguments ) {
		...
		return sb.right( arguments.getAsInteger( Key.count ) );
	}
