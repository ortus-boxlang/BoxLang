...
public class SetToList extends BIF {
	 ...
	 *
	 * @argument.delimiter The delimiter between elements (defaults to ",").
	 *
	 * @return A delimited string of all elements (in iteration order for LINKED/SORTED).
	 */
