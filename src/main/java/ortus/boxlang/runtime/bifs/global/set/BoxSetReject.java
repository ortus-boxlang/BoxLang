...
@BoxBIF( description = "Return a new Set containing only the elements for which the predicate returns false." )
@BoxMember( type = BoxLangType.SET, name = "reject" )
public class BoxSetReject extends BIF {
	 ...
	 * (the inverse of setFilter). The result is a new Set of the same variant as the source; the source is not
	 ...
	 *                    Elements for which this returns {@code false} are included in the result.
	 */
	public Object _invoke( IBoxContext context, ArgumentsScope arguments ) {
		return SetUtil.reject( arguments.getAsSet( Key.set ), arguments.getAsFunction( Key.callback ), context );
	}
