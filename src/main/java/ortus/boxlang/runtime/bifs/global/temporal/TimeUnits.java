...
@BoxMember( type = BoxLangType.STRING_STRICT, name = "monthAsString" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "monthShortAsString" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "day" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "dayOfWeek" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "dayOfWeekAsString" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "dayOfWeekShortAsString" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "daysInMonth" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "daysInYear" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "dayOfYear" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "firstDayOfMonth" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "week" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "hour" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "minute" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "second" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "millisecond" )
@BoxMember( type = BoxLangType.STRING_STRICT, name = "nanosecond" )
