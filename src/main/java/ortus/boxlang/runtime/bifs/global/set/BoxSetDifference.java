...
@BoxBIF( description = "Compute the difference (A − B) of two Sets." )
@BoxMember( type = BoxLangType.SET, name = "difference" )
public class BoxSetDifference extends BIF {

	public BoxSetDifference() {
		super();
	...
	/**
	 * Compute the relative complement (A − B) of two Sets. Returns a new Set containing all elements that are in
	 * A but not in B. The result is a new Set of the same variant as A; neither input is modified.
	 *
	 * @param context   The context in which the BIF is being invoked.
	 * @param arguments Argument scope for the BIF.
	 *
	 * @argument.set The source set (A).
	 *
	 * @argument.otherSet The set to subtract (B). Accepts any value castable to a Set.
	 */
