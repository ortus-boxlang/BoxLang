...
@BoxBIF( description = "Reverses the contents of the StringBuilder buffer in place. Returns the StringBuilder for chaining." )
@BoxMember( type = BoxLangType.STRING_BUILDER_STRICT, name = "reverse" )
public class StringBuilderReverse extends BIF {
	 ...
	 *
	 * @argument.stringBuilder The StringBuilder to reverse.
	 */
	@Override
