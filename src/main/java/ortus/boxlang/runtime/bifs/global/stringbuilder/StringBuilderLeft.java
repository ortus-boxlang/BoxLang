...
@BoxBIF
@BoxMember( type = BoxLangType.STRING_BUILDER_STRICT, name = "left" )
public class StringBuilderLeft extends BIF {

	public StringBuilderLeft() {
		super();
	...
	public Object _invoke( IBoxContext context, ArgumentsScope arguments ) {
		...
		return sb.left( arguments.getAsInteger( Key.count ) );
	}
