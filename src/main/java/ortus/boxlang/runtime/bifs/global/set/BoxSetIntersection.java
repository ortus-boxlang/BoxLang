...
@BoxBIF( description = "Compute the intersection (A ∩ B) of two Sets." )
@BoxMember( type = BoxLangType.SET, name = "intersection" )
public class BoxSetIntersection extends BIF {

	public BoxSetIntersection() {
		super();
	 ...
	 * in both A and B. The result is a new Set of the same variant as A; neither input is modified.
	 *
