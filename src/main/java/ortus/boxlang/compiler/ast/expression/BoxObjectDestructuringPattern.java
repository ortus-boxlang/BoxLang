...
/**
 * An object destructuring pattern used on the left-hand side of assignments.
 */
public class BoxObjectDestructuringPattern extends BoxExpression {
	...
	public Map<String, Object> toMap() {
		...
		map.put( "bindings", bindings.stream().map( BoxObjectDestructuringBinding::toMap ).collect( Collectors.toList() ) );
		return map;
	}
