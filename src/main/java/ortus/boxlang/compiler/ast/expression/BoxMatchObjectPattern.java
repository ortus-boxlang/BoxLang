...
/**
 * A match pattern wrapping object destructuring syntax.
 */
public class BoxMatchObjectPattern extends BoxMatchPattern {

	private BoxObjectDestructuringPattern pattern;

	public BoxMatchObjectPattern( BoxObjectDestructuringPattern pattern, Position position, String sourceText ) {
