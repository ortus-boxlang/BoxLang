...
/**
 * Abstract Node class representing SQL date literal
 */
public class SQLDateLiteral extends SQLExpression {
	 ...
	 */
	public SQLDateLiteral( DateTime value, Position position, String sourceText ) {
		super( position, sourceText );
		setValue( value );
	}

	/**
	 * Get the value of the Date literal
	 *
	 * @return the value of the Date literal
	 */
