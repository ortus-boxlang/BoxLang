 ...
 *
 * <p>The IBoxpiler interface provides a comprehensive API for:</p>
 * <ul>
 ...
 * <p>The compiler supports multiple compilation modes for different BoxLang constructs:</p>
 * <ul>
 ...
 * <p>BoxLang uses ANTLR v4 with multiple grammar parsers for different syntaxes:</p>
 * <ul>
 ...
 * <p>Concrete implementations of this interface (e.g., ASMBoxpiler, JavaBoxpiler) must:</p>
 * <ul>
...
public interface IBoxpiler {
	 ...
	 * 
	 * <p>This version number is embedded in every compiled class file and is used to determine
	 * compatibility when loading pre-compiled classes. The version is incremented whenever
	 * breaking changes are made to:</p>
	 * <ul>
	 ...
	 * </ul>
	 * 
	 * <p>When loading a pre-compiled class, the runtime checks this version to ensure the
	 * bytecode is compatible. Mismatched versions will trigger recompilation from source.</p>
	 */
	 ...
	 * 
	 * <p>Since BoxLang compiles to JVM bytecode, we must avoid using Java reserved words
	 ...
	 * Java's syntax.</p>
	 * 
	 * <p>BoxLang developers can still use these words in their source code, but the compiler
	 * will automatically rename them in the generated bytecode to avoid conflicts.</p>
	 */
	 ...
	 * 
	 * <p>This is a utility method that should be moved to a dedicated utility class.</p>
	 *
	 ...
	 * 
	 * <p>BoxLang generates inner classes for functions, closures, lambdas, and component body code.
	 * This method strips these suffixes to retrieve the original class FQN:</p>
	 * <ul>
	 ...
	 * </ul>
	 * 
	 * <p>This is essential for source map lookup and debugging, as source maps are stored
	 * against the base class, not the inner classes.</p>
	 *
