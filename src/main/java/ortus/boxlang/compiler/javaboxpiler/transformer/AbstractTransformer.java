...
public abstract class AbstractTransformer implements Transformer {
	...
	public Expression transformDocumentation( List<BoxDocumentationAnnotation> documentation ) {
		...
		if ( members.isEmpty() ) {
			...
			MethodCallExpr documentationStruct = ( MethodCallExpr ) parseExpression( "Struct.linkedOfNonConcurrent()", new HashMap<>() );
	...
	public Expression transformAnnotations( List<BoxAnnotation> annotations, Boolean defaultTrue, boolean onlyLiteralValues ) {
		...
		if ( annotations.isEmpty() ) {
			...
			MethodCallExpr annotationStruct = ( MethodCallExpr ) parseExpression( "Struct.linkedOfNonConcurrent()", new HashMap<>() );
