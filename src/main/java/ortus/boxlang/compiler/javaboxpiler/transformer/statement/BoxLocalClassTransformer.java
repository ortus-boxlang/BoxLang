...
/**
 * Named local classes are pre-compiled before script/template body transformation.
 * The source declaration statement itself emits no runtime Java statement.
 */
