/**
* Copied from test\tickets\LDEV3734.cfc in Lucee
*/
component extends="testbox.system.BaseSpec"{
    ...
    function run( testResults, textbox ) {
        ...
        describe("testcase for LDEV-3734", function(){
            ...
            it(title="Arithmetic bitwise AND with NULL in QoQ", body=function( currentSpec ){
                qry = QueryNew('foo','integer',[[40]]);
                var actual = queryExecute(
            ...
            it(title="Arithmetic bitwise OR with NULL in QoQ", body=function( currentSpec ){
                qry = QueryNew('foo','integer',[[40]]);
                var actual = queryExecute(
                    "SELECT 5|3 AS result,
                      NULL|5 as result2,
            ...
            it(title="Arithmetic bitwise NOT with NULL in QoQ", body=function( currentSpec ){
                qry = QueryNew('foo','integer',[[40]]);
                var actual = queryExecute(
                    "SELECT ~5 AS result,
                      ~NULL as result2
            ...
            it(title="Arithmetic bitwise XOR with NULL in QoQ", body=function( currentSpec ){
                qry = QueryNew('foo','integer',[[40]]);
                var actual = queryExecute(
