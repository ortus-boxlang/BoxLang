...
public class WatcherExistsTest {
	...
	@DisplayName( "It returns true when the watcher is registered" )
	@Test
	public void testWatcherExistsTrue() {
	...
	@DisplayName( "It returns false when the watcher is not registered" )
	@Test
	public void testWatcherExistsFalse() {
		instance.executeSource(
		    """
		    result = watcherExists( "does-not-exist" )
		    """,
		    this.context
		);

		assertThat( this.variables.getAsBoolean( Key.of( "result" ) ) ).isFalse();
	}
