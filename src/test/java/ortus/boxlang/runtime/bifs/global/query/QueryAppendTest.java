...
public class QueryAppendTest {
	...
	@DisplayName( "It should append the queries together" )
	@Test
	public void testAppendValue() {
		...
		instance.executeSource(
		    ...
		    query1= queryNew("col1,col2","string,integer", [ {col1: "foo", col2: 42 } ]);
		       ...
		       result = queryAppend(query1, query2);
		          """,
		    context );
		...
		assertThat( queryResult.getRow( 0 )[ 0 ] ).isEqualTo( "foo" );
		assertThat( queryResult.getRow( 1 )[ 0 ] ).isEqualTo( "bar" );
	}
