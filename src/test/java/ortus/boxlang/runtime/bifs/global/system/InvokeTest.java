...
public class InvokeTest {
	...
	public void testInvokeWebServiceWithWrapper() {
		...
		instance.executeSource(
		    """
				...
				result = invoke( ws, "ListOfContinentsByName", {} );
		    """.formatted( testWSDL ),
		    context );
		// @formatter:on
	...
	public void testInvokeWebServiceWithArguments() {
		...
		instance.executeSource(
		    """
				ws = createObject( "webservice", "%s" );
				result = invoke( ws, "CountryCurrency", { sCountryISOCode : "US" } );
		    """.formatted( testWSDL ),
		    context );
		// @formatter:on
	...
	public void testInvokeWebServiceLanguageName() {
		...
		instance.executeSource(
		    """
				ws = createObject( "webservice", "%s" );
				result = invoke( ws, "LanguageName", { sISOCode : "eng" } );
		    """.formatted( testWSDL ),
		    context );
		// @formatter:on
		String results = variables.getAsString( result );
	...
	public void testInvokeWebServiceFullCountryInfo() {
		...
		instance.executeSource(
		    """
				ws = createObject( "webservice", "%s" );
				result = invoke( ws, "FullCountryInfo", { sCountryISOCode : "US" } );
		    """.formatted( testWSDL ),
		    context );
		// @formatter:on
		IStruct results = variables.getAsStruct( result );
	...
	public void testInvokeWebServiceCountriesUsingCurrency() {
		...
		instance.executeSource(
		    """
				ws = createObject( "webservice", "%s" );
				result = invoke( ws, "CountriesUsingCurrency", { sISOCurrencyCode : "EUR" } );
		    """.formatted( testWSDL ),
		    context );
		// @formatter:on
		Array results = variables.getAsArray( result );
