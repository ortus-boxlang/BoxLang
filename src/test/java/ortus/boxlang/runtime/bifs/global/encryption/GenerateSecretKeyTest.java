...
public class GenerateSecretKeyTest {
	...
	@DisplayName( "It tests the BIF GenerateSecretKey" )
	@Test
	public void testKeyGeneration() {
		...
		assertTrue(
		    EncryptionUtil.decodeKey( variables.getAsString( result ), EncryptionUtil.DEFAULT_ENCRYPTION_ALGORITHM ) instanceof javax.crypto.SecretKey );
