...
public class WatcherGetTest {
	...
	@DisplayName( "It retrieves a registered watcher by name" )
	@Test
	public void testWatcherGet() {
		instance.executeSource(
		    """
		    created = watcherNew( "myWatcher", [ "./src" ], ( event, watcherContext ) => {} )
		    result  = watcherGet( "myWatcher" )
		    """,
		    this.context
		);
	...
	@DisplayName( "It throws when the watcher name does not exist" )
	@Test
