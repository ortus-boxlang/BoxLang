...
public class QueryReduceTest {
	...
	@DisplayName( "It should reduce the query to a single value" )
	@Test
	public void testReduceQuery() {
		instance.executeSource(
		    ...
		    function reduceFn( previousValue, currentValue, currentIndex, query ){
		    	return previousValue + currentValue.id;
		    };

		    result = QueryReduce( query, reduceFn, 0 );
		    """,
		    context );
	...
	@Test
	public void testReduceQueryMemberFunction() {
		instance.executeSource(
		    """
		    query = QueryNew( "id,name", "integer,varchar" );
		    QueryAddRow( query, { id = 1, name = "John" } );
		    ...
		    result = query.reduce( function( previousValue, currentValue, currentIndex, query ){
		    	return previousValue + currentValue.id;
		    }, 0 );
		    """,
		    context );
