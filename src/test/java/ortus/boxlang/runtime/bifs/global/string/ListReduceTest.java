...
public class ListReduceTest {
	...
	@DisplayName( "It tests the BIF ListReduce with defaults" )
	@Test
	public void testBIF() {
		instance.executeSource(
		    """
		              ...
		              result = listReduce( nums, sumReduce, 0 );
		    """,
		    context );
		assertThat( variables.get( result ) ).isEqualTo( 15 );
	}

	@DisplayName( "It tests the BIF ListReduce with an alternate delimiter" )
	@Test
	...
	public void testArrowFunction() {
		instance.executeSource(
		    """
		              ...
		              result = listReduce( nums, ( acc, num ) => acc + num, 0 );
		    """,
		    context );
		assertThat( variables.get( result ) ).isEqualTo( 15 );
	}

	@DisplayName( "Tests ListReduce with Lambda" )
	@Test
	...
	public void testComplexAccumulator() {
		instance.executeSource(
		    """
		        ...
		        result = listReduce( people, nameReduce, {indexes:[]} );
		    """,
		    context );
