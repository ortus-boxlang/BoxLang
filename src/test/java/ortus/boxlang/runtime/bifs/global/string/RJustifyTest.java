...
public class RJustifyTest {
	...
	@DisplayName( "It right-justifies a string to the specified length" )
	@Test
	public void testRightJustifyString() {
		instance.executeSource(
		    """
		    result = RJustify("BoxLang", 10);
		    """,
		    context );
		assertThat( variables.get( result ) ).isEqualTo( "   BoxLang" );
	}

	@DisplayName( "It right-justifies a string to the specified length as member" )
	@Test
	public void testRightJustifyStringMember() {
		instance.executeSource(
		    """
		    result = "BoxLang".RJustify(10);
		    """,
		    context );
		assertThat( variables.get( result ) ).isEqualTo( "   BoxLang" );
	}
	...
	public void testOriginalStringIfLonger() {
		instance.executeSource(
		    """
		    result = RJustify("Ortus Solutions", 10);
		    """,
		    context );
