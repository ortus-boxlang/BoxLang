...
public class FutureNewTest {
	...
	@DisplayName( "Create an incomplete future" )
	@Test
	public void testIncompleteFuture() {
		...
		// Check the result
		assertThat( variables.get( result ) ).isInstanceOf( BoxFuture.class );
	}

	@DisplayName( "Create an complete future" )
	@Test
	public void testCompleteFuture() throws InterruptedException, ExecutionException {
		// @formatter:off
		instance.executeSource("""
			result = FutureNew( 42 );
		""", context);
