...
public class QueryEveryTest {
	...
	@DisplayName( "It should return true if all the values match" )
	@Test
	public void testReturnTrueIfAllMatch() {
		instance.executeSource(
		    ...
		    result = QueryEvery( query, eachFn );
		    """,
		    context );
	...
	@DisplayName( "It should return false if any of the values do not match" )
	@Test
	...
	public void testQueryEveryMemberFunction() {
		instance.executeSource(
		    ...
		    result = query.every( function( row, i, query ){
		    	return row.id > 0;
		    } );
		    """,
		    context );
