...
public class WatcherListTest {
	...
	@DisplayName( "It returns an array of all registered watcher names" )
	@Test
	public void testWatcherList() {
	...
	@DisplayName( "It returns an empty array when no watchers are registered" )
	@Test
	public void testWatcherListEmpty() {
		instance.executeSource(
		    """
		    result = watcherList()
		    """,
