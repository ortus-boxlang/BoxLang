...
public class QueryDeleteRowTest {
	...
	@DisplayName( "It should delete a row from the query" )
	@Test
	public void testQueryDeleteRow() {
	...
	@Test
	public void testQueryDeleteRowMemberFunction() {
		instance.executeSource(
		    """
		    query = QueryNew( "id,name", "integer,varchar" );
		    query.addRow( { id = 1, name = "John" } );
		    query.addRow( { id = 2, name = "Jane" } );
		    query.addRow( { id = 3, name = "Jim" } );
		    query.addRow( { id = 4, name = "Jill" } );
		    query.addRow( { id = 5, name = "Jack" } );
		    query.deleteRow( 3 );
