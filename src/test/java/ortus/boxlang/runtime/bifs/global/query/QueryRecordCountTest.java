...
public class QueryRecordCountTest {
	...
	@DisplayName( "It should return the number of records in a query" )
	@Test
	...
	@DisplayName( "It should work when calling the member function" )
	@Test
	public void testQueryRecordCountMemberFunction() {
		instance.executeSource(
		    """
		    query = QueryNew( "id,name", "integer,varchar" );
		    QueryAddRow( query, { id = 1, name = "John" } );
