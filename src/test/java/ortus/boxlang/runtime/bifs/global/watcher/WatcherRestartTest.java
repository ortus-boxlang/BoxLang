...
public class WatcherRestartTest {
	...
	@DisplayName( "It restarts a watcher and returns the instance" )
	@Test
	public void testWatcherRestart() {
		instance.executeSource(
		    """
		    created = watcherNew( "myWatcher", [ "./src" ], ( event, watcherContext ) => {} )
		    watcherStart( "myWatcher" )
		    result = watcherRestart( "myWatcher" )
		    """,
		    this.context
		);
