...
public class AssertTest {
	...
	@DisplayName( "It can do a normal assert expression" )
	@Test
	...
	@DisplayName( "It can throw an exception for a failing assert" )
	@Test
	public void testFailingAssert() {
		assertThrows( AssertionError.class, () -> instance.executeSource(
		    """
		    assert 2 + 2 == 5
		    """,
		    context ) );
	...
	@DisplayName( "It can throw an exception with a custom message for a failing assert" )
	@Test
	public void testFailingAssertWithMessage() {
		AssertionError ex = assertThrows( AssertionError.class, () -> instance.executeSource(
		    """
		    assert 2 + 2 == 5 : "Math is broken!"
		    """,
		    context ) );
		assertThat( ex.getMessage() ).contains( "Math is broken!" );
