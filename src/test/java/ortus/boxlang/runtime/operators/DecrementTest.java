...
public class DecrementTest {
	...
	@DisplayName( "Decrementing a Set throws BoxRuntimeException" )
	@Test
	void testDecrementSetThrows() {
		assertThrows( BoxRuntimeException.class, () -> Decrement.invoke( ( Object ) new BoxSet() ) );
	}
