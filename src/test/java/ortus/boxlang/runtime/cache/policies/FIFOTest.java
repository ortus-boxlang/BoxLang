...
public class FIFOTest extends BasePolicyTest {

	@Test
	@DisplayName( "FIFO Cache Policy: Comparator Test" )
	void testComparator() {
		...
		FIFO policy = new FIFO();

		// Test the ordering according to the lastAccessed
		assertEntries( policy, entry1, entry2, entry3 );
