...
public class ThreadTest {
	...
	@DisplayName( "It can call auto-generated setter from within a thread" )
	@Test
	public void testThreadCallsAutoGeneratedSetter() {
		// @formatter:off
		instance.executeSource(
			"""
			obj = new src.test.java.ortus.boxlang.runtime.components.async.ThreadSetterTest();
			obj.doThreadedSet( "hello" );
			result = obj.getMyValue();
			""",
			context, BoxSourceType.BOXSCRIPT );
		// @formatter:on
